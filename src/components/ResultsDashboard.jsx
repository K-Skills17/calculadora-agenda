...
export default function ResultsDashboard({ results, leadData }) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Olá! Fiz a Calculadora de Agenda Ideal da minha clínica "${leadData.clinica}" e descobri que posso ganhar ${formatCurrency(results.receitaExtra)} a mais por mês otimizando minha agenda. Gostaria de saber como atrair os pacientes certos para preencher essa agenda ideal.`
  );
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      pdf.save(`agenda-ideal-${leadData.clinica.toLowerCase().replace(/\s+/g, '-')}.pdf`);
    } catch {
